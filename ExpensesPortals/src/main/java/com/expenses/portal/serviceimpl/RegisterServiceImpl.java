...
public class RegisterServiceImpl implements RegisterService {
    ...
    public RegisterServiceImpl(LoginRepository loginRepository,PasswordEncoder passwordEncoder) {
